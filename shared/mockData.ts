...
export const seedTrips: Trip[] = [
  ...
  // DO-003: TikTok Qianhai → Huanggang (rejected)
  {
    ...
    jobs: [
      ...
      { id: 'T00003-02', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'Huanggang Port', date: '2026-03-10 13:00' }, destination: { location: 'Huanggang Port', date: '2026-03-10 16:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Pending', duration: null, execution: null, activityLog: [log('l3','2026-03-10 07:00','Job created')], proofDocuments: [], fees: [], l2CostIds: ['EC001', 'EC002', 'EC003'] },
    ],
  },
  // DO-004: Shein Guangzhou → Airport (1 completed with under-invoice, 1 in progress)
  {
    ...
    jobs: [
      ...
      { id: 'T00004-02', vendor: { code: 'V-004', name: 'ThaiKee' }, origin: { location: 'Guangzhou Baiyun Airport', date: '2026-03-10 18:00' }, destination: { location: 'Guangzhou Baiyun Airport', date: '2026-03-10 21:00' }, service: { code: 'OH', label: 'Origin Handling' }, status: 'In Progress', duration: null, execution: '2026-03-10 18:10', activityLog: [log('l3','2026-03-10 10:00','Job created'), log('l4','2026-03-10 18:10','Status → In Progress')], proofDocuments: [], rateId: 'RT-017', agreedRate: { currency: 'MYR', amount: 0.65, unit: 'per-kg' }, agreedCost: { currency: 'MYR', amount: 338 }, fees: [{ id: 'F-010-01', name: 'Base rate', feeId: 'RT-017', currency: 'MYR', rate: 0.65, unit: 'per-kg', quantity: 520, amount: 338, active: true }], l2CostIds: ['OH001', 'OH002', 'OH003'] },
    ],
  },
  // DO-005: Temu SZX → Lantau (all pending, rates assigned, mixed currencies)
  {
    ...
    jobs: [
      { id: 'T00005-01', vendor: { code: 'V-002', name: 'SevenSeas' }, origin: { location: 'Shenzhen Bao An Airport', date: '2026-03-11 08:00' }, destination: { location: 'Shenzhen Bao An Airport', date: '2026-03-11 10:00' }, service: { code: 'CR', label: 'Cargo Retrieval' }, status: 'Pending', duration: null, execution: null, activityLog: [log('l1','2026-03-11 06:00','Job created')], proofDocuments: [], rateId: 'RT-015', agreedRate: { currency: 'CNY', amount: 30, unit: 'per-bag' }, agreedCost: { currency: 'CNY', amount: 1440 }, fees: [{ id: 'F-011-01', name: 'Base rate', feeId: 'RT-015', currency: 'CNY', rate: 30, unit: 'per-bag', quantity: 48, amount: 1440, active: true }], l2CostIds: ["CR001","CR002"] },
  ...
  // DO-009: Shein Dongguan → SZX (rejected + reassigned)
  {
    ...
    jobs: [
      ...
      { id: 'T00009-02', vendor: { code: 'V-002', name: 'SevenSeas' }, origin: { location: 'SZX Airport', date: '2026-03-13 13:00' }, destination: { location: 'SZX Airport', date: '2026-03-13 16:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Pending', duration: null, execution: null, activityLog: [log('l3','2026-03-13 06:30','Job created')], proofDocuments: [], fees: [], l2CostIds: ['EC001', 'EC002', 'EC003'] },
      { id: 'T00009-03', vendor: { code: 'V-002', name: 'SevenSeas' }, origin: { location: 'SZX Airport', date: '2026-03-13 17:00' }, destination: { location: 'SZX Airport', date: '2026-03-13 19:00' }, service: { code: 'CS', label: 'Cargo Submission' }, status: 'Pending', duration: null, execution: null, activityLog: [log('l4','2026-03-13 06:30','Job created')], proofDocuments: [], fees: [], l2CostIds: ['CS001', 'CS002', 'CS003', 'CS005'] },
    ],
  },
  ...
  // T00013: TikTok — HaleSun FM(In Progress) + Gonda EC(Pending) + SevenSeas CS(Pending) + HaleSun OH(Pending)
  {
    ...
    jobs: [
      ...
      { id: 'T00013-02', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'Shenzhen Bay Checkpoint', date: '2026-03-15 11:00' }, destination: { location: 'Shenzhen Bay Checkpoint', date: '2026-03-15 14:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Pending', duration: null, execution: null, activityLog: [log('l72','2026-03-15 06:00','Job created')], proofDocuments: [], fees: [{ id: 'F-071-01', name: '报关费', currency: 'CNY', rate: 400, unit: 'flat', quantity: 1, amount: 400, active: true }], l2CostIds: ["EC001","EC002","EC003"] },
  ...
  // T00018: AliExpress — ThaiKee FM(In Progress) + ThaiKee EC(Pending) — ThaiKee doing EC
  {
    ...
    jobs: [
      { id: 'T00018-01', vendor: { code: 'V-004', name: 'ThaiKee' }, origin: { location: 'Dongguan Factory', date: '2026-03-17 09:00' }, destination: { location: 'Huanggang Port', date: '2026-03-17 12:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'In Progress', duration: null, execution: '2026-03-17 09:10', activityLog: [log('l130','2026-03-17 08:00','Job created','Ops Admin','Assigned to ThaiKee'), log('l131','2026-03-17 09:10','Status → In Progress')], proofDocuments: [], agreedCost: { currency: 'CNY', amount: 1200 }, fees: [{ id: 'F-130-01', name: 'FTL运费 3T', currency: 'CNY', rate: 1200, unit: 'flat', quantity: 1, amount: 1200, active: true }], l2CostIds: ["FM001","FM002"] },
      { id: 'T00018-02', vendor: { code: 'V-004', name: 'ThaiKee' }, origin: { location: 'Huanggang Port', date: '2026-03-17 13:00' }, destination: { location: 'Huanggang Port', date: '2026-03-17 16:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Pending', duration: null, execution: null, activityLog: [log('l132','2026-03-17 08:00','Job created')], proofDocuments: [], fees: [{ id: 'F-131-01', name: '报关费', currency: 'CNY', rate: 280, unit: 'flat', quantity: 1, amount: 280, active: true }], l2CostIds: ["EC001","EC002","EC003"] },
    ],
  },
  ...
  // T00020: Temu — HaleSun FM(Pending) + HaleSun OH(Pending) — HaleSun doing OH
  {
    ...
    jobs: [
      { id: 'T00020-01', vendor: { code: 'V-001', name: 'HaleSun' }, origin: { location: 'Yantian Port', date: '2026-03-17 12:00' }, destination: { location: 'SZX Cargo Terminal', date: '2026-03-17 16:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Pending', duration: null, execution: null, activityLog: [log('l160','2026-03-17 11:00','Job created','Ops Admin','Assigned to HaleSun')], proofDocuments: [], agreedCost: { currency: 'MYR', amount: 520 }, fees: [{ id: 'F-160-01', name: 'FTL运费 3T', currency: 'MYR', rate: 520, unit: 'flat', quantity: 1, amount: 520, active: true }], l2CostIds: ["FM001","FM002"] },
...
export const seedLocations: Location[] = [
  ...
  { id: 'LOC-001', name: 'TikTok WH, Shenzhen', code: 'SZ-TTWH', zone: 'Shenzhen', type: 'warehouse', city: 'Shenzhen', district: "Bao'an District", districtCode: '440306' },
  { id: 'LOC-002', name: 'Shenzhen Bay Checkpoint', code: 'SZ-BAY', zone: 'Shenzhen', type: 'checkpoint', city: 'Shenzhen', district: 'Nanshan District', districtCode: '440305' },
  { id: 'LOC-003', name: 'SZX Airport Cargo Terminal', code: 'SZX-CT', zone: 'Shenzhen', type: 'airport', city: 'Shenzhen', district: "Bao'an District", districtCode: '440306' },
  { id: 'LOC-004', name: 'Qianhai Free Trade Zone', code: 'SZ-QH', zone: 'Shenzhen', type: 'hub', city: 'Shenzhen', district: 'Nanshan District', districtCode: '440305' },
  { id: 'LOC-005', name: 'Huanggang Port', code: 'SZ-HG', zone: 'Shenzhen', type: 'port', city: 'Shenzhen', district: 'Futian District', districtCode: '440304' },
  { id: 'LOC-006', name: 'Shenzhen Bao An Airport', code: 'SZX-BA', zone: 'Shenzhen', type: 'airport', city: 'Shenzhen', district: "Bao'an District", districtCode: '440306' },
  { id: 'LOC-007', name: 'Shekou Port', code: 'SZ-SK', zone: 'Shenzhen', type: 'port', city: 'Shenzhen', district: 'Nanshan District', districtCode: '440305' },
  { id: 'LOC-008', name: 'Shenzhen Nanshan WH', code: 'SZ-NS', zone: 'Shenzhen', type: 'warehouse', city: 'Shenzhen', district: 'Nanshan District', districtCode: '440305' },
  { id: 'LOC-009', name: 'Shenzhen Bay Hub', code: 'SZ-BH', zone: 'Shenzhen', type: 'hub', city: 'Shenzhen', district: 'Nanshan District', districtCode: '440305' },
  { id: 'LOC-010', name: 'SZX Cargo Terminal', code: 'SZX-CG', zone: 'Shenzhen', type: 'airport', city: 'Shenzhen', district: "Bao'an District", districtCode: '440306' },
  { id: 'LOC-011', name: 'Shenzhen Airport', code: 'SZX', zone: 'Shenzhen', type: 'airport', city: 'Shenzhen', district: "Bao'an District", districtCode: '440306' },
  { id: 'LOC-012', name: 'SZX Airport', code: 'SZX-AP', zone: 'Shenzhen', type: 'airport', city: 'Shenzhen', district: "Bao'an District", districtCode: '440306' },
  // Guangzhou zone
  { id: 'LOC-013', name: 'Guangzhou Baiyun Airport', code: 'CAN-BY', zone: 'Guangzhou', type: 'airport', city: 'Guangzhou', district: 'Baiyun District', districtCode: '440111' },
  { id: 'LOC-014', name: 'Guangzhou Warehouse', code: 'GZ-WH', zone: 'Guangzhou', type: 'warehouse', city: 'Guangzhou', district: 'Huangpu District', districtCode: '440112' },
  { id: 'LOC-015', name: 'Huangpu Port', code: 'GZ-HP', zone: 'Guangzhou', type: 'port', city: 'Guangzhou', district: 'Huangpu District', districtCode: '440112' },
  { id: 'LOC-016', name: 'Guangzhou Region Airport', code: 'CAN-RG', zone: 'Guangzhou', type: 'airport', city: 'Guangzhou', district: 'Baiyun District', districtCode: '440111' },
  // Hong Kong zone
  { id: 'LOC-017', name: 'Lantau Terminals', code: 'HK-LT', zone: 'Hong Kong', type: 'port', city: 'Hong Kong', district: 'Islands District', districtCode: '810118' },
  { id: 'LOC-018', name: 'Hong Kong Airport', code: 'HKG', zone: 'Hong Kong', type: 'airport', city: 'Hong Kong', district: 'Islands District', districtCode: '810118' },
  // Dongguan zone — prefecture-level city without standard sub-districts in scope
  { id: 'LOC-019', name: 'Dongguan Cross-dock', code: 'DG-CD', zone: 'Dongguan', type: 'hub', city: 'Dongguan', district: 'Dongguan City', districtCode: '441900' },
  { id: 'LOC-020', name: 'Dongguan Factory', code: 'DG-FC', zone: 'Dongguan', type: 'warehouse', city: 'Dongguan', district: 'Dongguan City', districtCode: '441900' },
  // Yantian zone (Shenzhen sub-area with its own district)
  { id: 'LOC-021', name: 'Yantian Port', code: 'YT-PT', zone: 'Yantian', type: 'port', city: 'Shenzhen', district: 'Yantian District', districtCode: '440308' },
  // Yiwu zone
  { id: 'LOC-022', name: 'Yiwu Warehouse', code: 'YW-WH', zone: 'Yiwu', type: 'warehouse', city: 'Yiwu', district: 'Yiwu City', districtCode: '330782' },
  // Ningbo zone
  { id: 'LOC-023', name: 'Ningbo Port', code: 'NB-PT', zone: 'Ningbo', type: 'port', city: 'Ningbo', district: 'Beilun District', districtCode: '330206' },
];
