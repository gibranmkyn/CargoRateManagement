...
export const seedTrips: Trip[] = [
  // DO-001: TikTok Shenzhen → SZX Airport (completed, all invoiced — 2 match, 1 over)
  {
    ...
    jobs: [
      { id: 'DO-20260308-001-J01', vendor: { code: 'V-001', name: 'HaleSun' }, origin: { location: 'TikTok WH, Shenzhen', date: '2026-03-08 10:00' }, destination: { location: 'Shenzhen Bay Checkpoint', date: '2026-03-08 14:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Completed', proofStatus: 'validated', duration: '04:00', execution: '2026-03-08 10:05', activityLog: [log('l1','2026-03-08 09:00','Job created','Ops Admin','Assigned to HaleSun'), log('l2','2026-03-08 10:05','Status → In Progress'), log('l3','2026-03-08 14:00','Status → Completed')], proofDocuments: [doc('d1','POD-tiktok-szbay.jpg','image/jpeg','2026-03-08 13:55')], rateId: 'RT-001', agreedRate: { currency: 'MYR', amount: 450, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 525 }, invoiceAmount: { currency: 'MYR', amount: 525 }, fees: [{ id: 'F-001-01', name: 'Base rate', feeId: 'RT-001', currency: 'MYR', rate: 450, unit: 'flat', quantity: 1, amount: 450, active: true }, { id: 'F-001-02', name: 'Fuel surcharge', currency: 'MYR', rate: 1.875, unit: 'per-km', quantity: 24, amount: 45, active: true }, { id: 'F-001-03', name: 'Toll fees', currency: 'MYR', rate: 30, unit: 'flat', quantity: 1, amount: 30, active: true }], jobBags: 24, jobWeight: 1240 },
      { id: 'DO-20260308-001-J02', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'Shenzhen Bay Checkpoint', date: '2026-03-08 15:00' }, destination: { location: 'SZX Airport Cargo Terminal', date: '2026-03-08 18:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Completed', proofStatus: 'validated', duration: '03:00', execution: '2026-03-08 15:10', activityLog: [log('l4','2026-03-08 09:00','Job created'), log('l5','2026-03-08 18:00','Status → Completed')], proofDocuments: [doc('d2','customs-clearance-001.pdf','application/pdf','2026-03-08 17:50')], rateId: 'RT-006', agreedRate: { currency: 'MYR', amount: 120, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 145 }, invoiceAmount: { currency: 'MYR', amount: 145 }, fees: [{ id: 'F-002-01', name: 'Base rate', feeId: 'RT-006', currency: 'MYR', rate: 120, unit: 'flat', quantity: 1, amount: 120, active: true }, { id: 'F-002-02', name: 'Special handling', currency: 'MYR', rate: 25, unit: 'flat', quantity: 1, amount: 25, active: true }], jobBags: 24, jobWeight: 1240 },
      { id: 'DO-20260308-001-J03', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'SZX Airport Cargo Terminal', date: '2026-03-08 19:00' }, destination: { location: 'SZX Airport Cargo Terminal', date: '2026-03-08 21:00' }, service: { code: 'CS', label: 'Cargo Submission' }, status: 'Completed', proofStatus: 'validated', duration: '02:00', execution: '2026-03-08 19:05', activityLog: [log('l6','2026-03-08 09:00','Job created'), log('l7','2026-03-08 21:00','Status → Completed')], proofDocuments: [doc('d3','xray-submission-receipt.pdf','application/pdf','2026-03-08 20:55')], rateId: 'RT-010', agreedRate: { currency: 'MYR', amount: 80, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 80 }, invoiceAmount: { currency: 'MYR', amount: 95 }, fees: [{ id: 'F-003-01', name: 'Base rate', feeId: 'RT-010', currency: 'MYR', rate: 80, unit: 'flat', quantity: 1, amount: 80, active: true }], jobBags: 24, jobWeight: 1240 },
    ],
  },
  // DO-002: Shopee Yantian → KUL (in progress, mixed currencies)
  {
    ...
    jobs: [
      { id: 'DO-20260309-002-J01', vendor: { code: 'V-001', name: 'HaleSun' }, origin: { location: 'Yantian Port', date: '2026-03-09 10:00' }, destination: { location: 'Dongguan Cross-dock', date: '2026-03-09 14:00' }, service: { code: 'CR', label: 'Cargo Retrieval' }, status: 'Completed', proofStatus: 'validated', duration: '04:00', execution: '2026-03-09 10:10', activityLog: [log('l1','2026-03-09 08:30','Job created'), log('l2','2026-03-09 14:00','Status → Completed')], proofDocuments: [doc('d1','retrieval-yantian.jpg','image/jpeg','2026-03-09 13:50')], rateId: 'RT-005', agreedRate: { currency: 'CNY', amount: 25, unit: 'per-bag' }, agreedCost: { currency: 'CNY', amount: 400 }, invoiceAmount: { currency: 'CNY', amount: 400 }, fees: [{ id: 'F-004-01', name: 'Base rate', feeId: 'RT-005', currency: 'CNY', rate: 25, unit: 'per-bag', quantity: 16, amount: 400, active: true }], jobBags: 16, jobWeight: 890 },
      { id: 'DO-20260309-002-J02', vendor: { code: 'V-001', name: 'HaleSun' }, origin: { location: 'Dongguan Cross-dock', date: '2026-03-09 15:00' }, destination: { location: 'Shenzhen Airport', date: '2026-03-09 19:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'In Progress', proofStatus: 'awaiting', duration: null, execution: '2026-03-09 15:05', activityLog: [log('l3','2026-03-09 08:30','Job created'), log('l4','2026-03-09 15:05','Status → In Progress')], proofDocuments: [], rateId: 'RT-002', agreedRate: { currency: 'MYR', amount: 520, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 520 }, fees: [{ id: 'F-005-01', name: 'Base rate', feeId: 'RT-002', currency: 'MYR', rate: 520, unit: 'flat', quantity: 1, amount: 520, active: true }], jobBags: 16, jobWeight: 890 },
      { id: 'DO-20260309-002-J03', vendor: { code: 'V-002', name: 'SevenSeas' }, origin: { location: 'Shenzhen Airport', date: '2026-03-09 20:00' }, destination: { location: 'Shenzhen Airport', date: '2026-03-09 23:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l5','2026-03-09 08:30','Job created')], proofDocuments: [], rateId: 'RT-012', agreedRate: { currency: 'CNY', amount: 580, unit: 'flat' }, agreedCost: { currency: 'CNY', amount: 580 }, fees: [{ id: 'F-006-01', name: 'Base rate', feeId: 'RT-012', currency: 'CNY', rate: 580, unit: 'flat', quantity: 1, amount: 580, active: true }], jobBags: 16, jobWeight: 890 },
    ],
  },
  // DO-003: TikTok Qianhai → Huanggang (rejected)
  {
    ...
    priority: true,
    jobs: [
      { id: 'DO-20260310-003-J01', vendor: { code: 'V-001', name: 'HaleSun' }, origin: { location: 'Qianhai Free Trade Zone', date: '2026-03-10 08:00' }, destination: { location: 'Huanggang Port', date: '2026-03-10 12:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Rejected', proofStatus: 'disputed', duration: null, execution: '2026-03-10 08:10', rejectionReason: 'Vehicle breakdown', activityLog: [log('l1','2026-03-10 07:00','Job created'), log('l2','2026-03-10 09:30','Status → Rejected','Ops Admin','Vehicle breakdown')], proofDocuments: [], fees: [], jobBags: 36, jobWeight: 1500 },
      { id: 'DO-20260310-003-J02', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'Huanggang Port', date: '2026-03-10 13:00' }, destination: { location: 'Huanggang Port', date: '2026-03-10 16:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l3','2026-03-10 07:00','Job created')], proofDocuments: [], fees: [], jobBags: 36, jobWeight: 1500 },
    ],
  },
  // DO-004: Shein Guangzhou → Airport (1 completed with under-invoice, 1 in progress)
  {
    ...
    jobs: [
      { id: 'DO-20260310-004-J01', vendor: { code: 'V-004', name: 'ThaiKee' }, origin: { location: 'Guangzhou Baiyun Airport', date: '2026-03-10 14:00' }, destination: { location: 'Guangzhou Baiyun Airport', date: '2026-03-10 17:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Completed', proofStatus: 'validated', duration: '03:00', execution: '2026-03-10 14:05', activityLog: [log('l1','2026-03-10 10:00','Job created'), log('l2','2026-03-10 17:00','Status → Completed')], proofDocuments: [doc('d1','gz-trucking-receipt.pdf','application/pdf','2026-03-10 16:50')], rateId: 'RT-016', agreedRate: { currency: 'MYR', amount: 280, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 280 }, invoiceAmount: { currency: 'MYR', amount: 250 }, fees: [{ id: 'F-009-01', name: 'Base rate', feeId: 'RT-016', currency: 'MYR', rate: 280, unit: 'flat', quantity: 1, amount: 280, active: true }], jobBags: 10, jobWeight: 520 },
      { id: 'DO-20260310-004-J02', vendor: { code: 'V-004', name: 'ThaiKee' }, origin: { location: 'Guangzhou Baiyun Airport', date: '2026-03-10 18:00' }, destination: { location: 'Guangzhou Region Airport', date: '2026-03-10 21:00' }, service: { code: 'OH', label: 'Origin Handling' }, status: 'In Progress', proofStatus: 'awaiting', duration: null, execution: '2026-03-10 18:10', activityLog: [log('l3','2026-03-10 10:00','Job created'), log('l4','2026-03-10 18:10','Status → In Progress')], proofDocuments: [], rateId: 'RT-017', agreedRate: { currency: 'MYR', amount: 0.65, unit: 'per-kg' }, agreedCost: { currency: 'MYR', amount: 338 }, fees: [{ id: 'F-010-01', name: 'Base rate', feeId: 'RT-017', currency: 'MYR', rate: 0.65, unit: 'per-kg', quantity: 520, amount: 338, active: true }], jobBags: 10, jobWeight: 520 },
    ],
  },
  // DO-005: Temu SZX → Lantau (all pending, rates assigned, mixed currencies)
  {
    ...
    jobs: [
      { id: 'DO-20260311-005-J01', vendor: { code: 'V-002', name: 'SevenSeas' }, origin: { location: 'Shenzhen Bao An Airport', date: '2026-03-11 08:00' }, destination: { location: 'Shenzhen Bao An Airport', date: '2026-03-11 10:00' }, service: { code: 'CR', label: 'Cargo Retrieval' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l1','2026-03-11 06:00','Job created')], proofDocuments: [], rateId: 'RT-015', agreedRate: { currency: 'CNY', amount: 30, unit: 'per-bag' }, agreedCost: { currency: 'CNY', amount: 1440 }, fees: [{ id: 'F-011-01', name: 'Base rate', feeId: 'RT-015', currency: 'CNY', rate: 30, unit: 'per-bag', quantity: 48, amount: 1440, active: true }], jobBags: 48, jobWeight: 2450 },
      { id: 'DO-20260311-005-J02', vendor: { code: 'V-005', name: 'The Lorry' }, origin: { location: 'Shenzhen Bao An Airport', date: '2026-03-11 11:00' }, destination: { location: 'Shekou Port', date: '2026-03-11 15:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l2','2026-03-11 06:00','Job created')], proofDocuments: [], rateId: 'RT-018', agreedRate: { currency: 'CNY', amount: 2800, unit: 'flat' }, agreedCost: { currency: 'CNY', amount: 2800 }, fees: [{ id: 'F-012-01', name: 'Base rate', feeId: 'RT-018', currency: 'CNY', rate: 2800, unit: 'flat', quantity: 1, amount: 2800, active: true }], jobBags: 48, jobWeight: 2450 },
      { id: 'DO-20260311-005-J03', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'Shekou Port', date: '2026-03-11 16:00' }, destination: { location: 'Lantau Terminals', date: '2026-03-11 20:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l3','2026-03-11 06:00','Job created')], proofDocuments: [], rateId: 'RT-009', agreedRate: { currency: 'CNY', amount: 680, unit: 'flat' }, agreedCost: { currency: 'CNY', amount: 680 }, fees: [{ id: 'F-013-01', name: 'Base rate', feeId: 'RT-009', currency: 'CNY', rate: 680, unit: 'flat', quantity: 1, amount: 680, active: true }], jobBags: 48, jobWeight: 2450 },
      { id: 'DO-20260311-005-J04', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'Lantau Terminals', date: '2026-03-11 21:00' }, destination: { location: 'Lantau Terminals', date: '2026-03-11 23:00' }, service: { code: 'CS', label: 'Cargo Submission' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l4','2026-03-11 06:00','Job created')], proofDocuments: [], rateId: 'RT-011', agreedRate: { currency: 'MYR', amount: 95, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 95 }, fees: [{ id: 'F-014-01', name: 'Base rate', feeId: 'RT-011', currency: 'MYR', rate: 95, unit: 'flat', quantity: 1, amount: 95, active: true }], jobBags: 48, jobWeight: 2450 },
    ],
  },
  // DO-006: AliExpress Yiwu → Ningbo (in progress, rates assigned)
  {
    ...
    jobs: [
      { id: 'DO-20260311-006-J01', vendor: { code: 'V-005', name: 'The Lorry' }, origin: { location: 'Yiwu Warehouse', date: '2026-03-11 10:00' }, destination: { location: 'Ningbo Port', date: '2026-03-11 16:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'In Progress', proofStatus: 'awaiting', duration: null, execution: '2026-03-11 10:15', activityLog: [log('l1','2026-03-11 09:00','Job created'), log('l2','2026-03-11 10:15','Status → In Progress')], proofDocuments: [], rateId: 'RT-019', agreedRate: { currency: 'CNY', amount: 3200, unit: 'flat' }, agreedCost: { currency: 'CNY', amount: 3200 }, fees: [{ id: 'F-015-01', name: 'Base rate', feeId: 'RT-019', currency: 'CNY', rate: 3200, unit: 'flat', quantity: 1, amount: 3200, active: true }], jobBags: 60, jobWeight: 3200 },
      { id: 'DO-20260311-006-J02', vendor: { code: 'V-002', name: 'SevenSeas' }, origin: { location: 'Ningbo Port', date: '2026-03-11 17:00' }, destination: { location: 'Ningbo Port', date: '2026-03-11 20:00' }, service: { code: 'OH', label: 'Origin Handling' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l3','2026-03-11 09:00','Job created')], proofDocuments: [], rateId: 'RT-014', agreedRate: { currency: 'MYR', amount: 0.85, unit: 'per-kg' }, agreedCost: { currency: 'MYR', amount: 2720 }, fees: [{ id: 'F-016-01', name: 'Base rate', feeId: 'RT-014', currency: 'MYR', rate: 0.85, unit: 'per-kg', quantity: 3200, amount: 2720, active: true }], jobBags: 60, jobWeight: 3200 },
    ],
  },
  // DO-007: Shopee Guangzhou → HK (completed, all match)
  {
    ...
    jobs: [
      { id: 'DO-20260312-007-J01', vendor: { code: 'V-001', name: 'HaleSun' }, origin: { location: 'Guangzhou Warehouse', date: '2026-03-12 09:00' }, destination: { location: 'Huangpu Port', date: '2026-03-12 13:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Completed', proofStatus: 'validated', duration: '04:00', execution: '2026-03-12 09:10', activityLog: [log('l1','2026-03-12 07:30','Job created'), log('l2','2026-03-12 13:00','Status → Completed')], proofDocuments: [doc('d1','gz-huangpu-pod.jpg','image/jpeg','2026-03-12 12:55')], rateId: 'RT-003', agreedRate: { currency: 'MYR', amount: 380, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 380 }, invoiceAmount: { currency: 'MYR', amount: 380 }, fees: [{ id: 'F-017-01', name: 'Base rate', feeId: 'RT-003', currency: 'MYR', rate: 380, unit: 'flat', quantity: 1, amount: 380, active: true }], jobBags: 12, jobWeight: 680 },
      { id: 'DO-20260312-007-J02', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'Huangpu Port', date: '2026-03-12 14:00' }, destination: { location: 'Hong Kong Airport', date: '2026-03-12 18:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Completed', proofStatus: 'validated', duration: '04:00', execution: '2026-03-12 14:05', activityLog: [log('l3','2026-03-12 07:30','Job created'), log('l4','2026-03-12 18:00','Status → Completed')], proofDocuments: [doc('d2','hk-customs-clearance.pdf','application/pdf','2026-03-12 17:50')], rateId: 'RT-008', agreedRate: { currency: 'MYR', amount: 150, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 150 }, invoiceAmount: { currency: 'MYR', amount: 150 }, fees: [{ id: 'F-018-01', name: 'Base rate', feeId: 'RT-008', currency: 'MYR', rate: 150, unit: 'flat', quantity: 1, amount: 150, active: true }], jobBags: 12, jobWeight: 680 },
    ],
  },
  // DO-008: TikTok Shenzhen → SZX (all pending)
  {
    ...
    jobs: [
      { id: 'DO-20260312-008-J01', vendor: { code: 'V-001', name: 'HaleSun' }, origin: { location: 'TikTok WH, Shenzhen', date: '2026-03-12 14:00' }, destination: { location: 'SZX Cargo Terminal', date: '2026-03-12 18:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l1','2026-03-12 11:00','Job created')], proofDocuments: [], rateId: 'RT-004', agreedRate: { currency: 'MYR', amount: 470, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 470 }, fees: [{ id: 'F-019-01', name: 'Base rate', feeId: 'RT-004', currency: 'MYR', rate: 470, unit: 'flat', quantity: 1, amount: 470, active: true }], jobBags: 32, jobWeight: 1800 },
      { id: 'DO-20260312-008-J02', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'SZX Cargo Terminal', date: '2026-03-12 19:00' }, destination: { location: 'SZX Cargo Terminal', date: '2026-03-12 22:00' }, service: { code: 'CS', label: 'Cargo Submission' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l2','2026-03-12 11:00','Job created')], proofDocuments: [], fees: [], jobBags: 32, jobWeight: 1800 },
    ],
  },
  // DO-009: Shein Dongguan → SZX (rejected + reassigned)
  {
    ...
    priority: true,
    jobs: [
      { id: 'DO-20260313-009-J01', vendor: { code: 'V-004', name: 'ThaiKee' }, origin: { location: 'Dongguan Factory', date: '2026-03-13 08:00' }, destination: { location: 'Shenzhen Bay Hub', date: '2026-03-13 12:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Rejected', proofStatus: 'disputed', duration: null, execution: '2026-03-13 08:10', rejectionReason: 'Capacity full', activityLog: [log('l1','2026-03-13 06:30','Job created'), log('l2','2026-03-13 10:00','Status → Rejected','Ops Admin','Capacity full')], proofDocuments: [], fees: [], jobBags: 20, jobWeight: 1100 },
      { id: 'DO-20260313-009-J02', vendor: { code: 'V-002', name: 'SevenSeas' }, origin: { location: 'Shenzhen Bay Hub', date: '2026-03-13 13:00' }, destination: { location: 'SZX Airport', date: '2026-03-13 16:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l3','2026-03-13 06:30','Job created')], proofDocuments: [], fees: [], jobBags: 20, jobWeight: 1100 },
      { id: 'DO-20260313-009-J03', vendor: { code: 'V-002', name: 'SevenSeas' }, origin: { location: 'SZX Airport', date: '2026-03-13 17:00' }, destination: { location: 'SZX Airport', date: '2026-03-13 19:00' }, service: { code: 'CS', label: 'Cargo Submission' }, status: 'Pending', proofStatus: 'awaiting', duration: null, execution: null, activityLog: [log('l4','2026-03-13 06:30','Job created')], proofDocuments: [], fees: [], jobBags: 20, jobWeight: 1100 },
    ],
  },
  // DO-010: Temu Shenzhen → Shekou (simple 1-job)
  {
    ...
    jobs: [
      { id: 'DO-20260313-010-J01', vendor: { code: 'V-005', name: 'The Lorry' }, origin: { location: 'Shenzhen Nanshan WH', date: '2026-03-13 10:00' }, destination: { location: 'Shekou Port', date: '2026-03-13 13:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'In Progress', proofStatus: 'awaiting', duration: null, execution: '2026-03-13 10:05', activityLog: [log('l1','2026-03-13 09:00','Job created'), log('l2','2026-03-13 10:05','Status → In Progress')], proofDocuments: [], rateId: 'RT-020', agreedRate: { currency: 'MYR', amount: 320, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 320 }, fees: [{ id: 'F-024-01', name: 'Base rate', feeId: 'RT-020', currency: 'MYR', rate: 320, unit: 'flat', quantity: 1, amount: 320, active: true }], jobBags: 8, jobWeight: 420 },
    ],
  },
];
...
// Legacy — kept empty for backward compat, will be removed
