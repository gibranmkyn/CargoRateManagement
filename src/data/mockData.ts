...
export const seedTrips: Trip[] = [
  // DO-001: TikTok Shenzhen → SZX Airport (completed, all invoiced — 2 match, 1 over)
  {
    ...
    jobs: [
      { id: 'DO-20260308-001-J01', vendor: { code: 'V-001', name: 'HaleSun' }, origin: { location: 'TikTok WH, Shenzhen', date: '2026-03-08 10:00' }, destination: { location: 'Shenzhen Bay Checkpoint', date: '2026-03-08 14:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Verified', duration: '04:00', execution: '2026-03-08 10:05', activityLog: [log('l1','2026-03-08 09:00','Job created','Ops Admin','Assigned to HaleSun'), log('l2','2026-03-08 10:05','Status → In Progress'), log('l3','2026-03-08 14:00','Status → Completed')], proofDocuments: [doc('d1','POD-tiktok-szbay.jpg','image/jpeg','2026-03-08 13:55')], rateId: 'RT-001', agreedRate: { currency: 'MYR', amount: 450, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 525 }, invoiceAmount: { currency: 'MYR', amount: 525 }, fees: [{ id: 'F-001-01', name: 'FTL运费 1.5T', feeId: 'FTL-001', currency: 'MYR', rate: 310, unit: 'flat', quantity: 1, amount: 310, active: true }], jobBags: 24, jobWeight: 1240 },
      { id: 'DO-20260308-001-J02', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'Shenzhen Bay Checkpoint', date: '2026-03-08 15:00' }, destination: { location: 'SZX Airport Cargo Terminal', date: '2026-03-08 18:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Verified', duration: '03:00', execution: '2026-03-08 15:10', activityLog: [log('l4','2026-03-08 09:00','Job created'), log('l5','2026-03-08 18:00','Status → Completed')], proofDocuments: [doc('d2','customs-clearance-001.pdf','application/pdf','2026-03-08 17:50')], rateId: 'VF-030', agreedCost: { currency: 'MYR', amount: 190 }, invoiceAmount: { currency: 'MYR', amount: 190 }, fees: [{ id: 'F-002-01', name: '报关费', feeId: 'VF-030', currency: 'MYR', rate: 120, unit: 'flat', quantity: 1, amount: 120, active: true }, { id: 'F-002-02', name: '查验费', feeId: 'VF-031', currency: 'MYR', rate: 45, unit: 'flat', quantity: 1, amount: 45, active: true }, { id: 'F-002-03', name: '报关服务费', feeId: 'VF-032', currency: 'MYR', rate: 25, unit: 'flat', quantity: 1, amount: 25, active: true }], jobBags: 24, jobWeight: 1240 },
      { id: 'DO-20260308-001-J03', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'SZX Airport Cargo Terminal', date: '2026-03-08 19:00' }, destination: { location: 'SZX Airport Cargo Terminal', date: '2026-03-08 21:00' }, service: { code: 'CS', label: 'Cargo Submission' }, status: 'Verified', duration: '02:00', execution: '2026-03-08 19:05', activityLog: [log('l6','2026-03-08 09:00','Job created'), log('l7','2026-03-08 21:00','Status → Completed')], proofDocuments: [doc('d3','xray-submission-receipt.pdf','application/pdf','2026-03-08 20:55')], rateId: 'VF-040', agreedCost: { currency: 'MYR', amount: 487 }, invoiceAmount: { currency: 'MYR', amount: 500 }, fees: [{ id: 'F-003-01', name: '地面操作费', feeId: 'VF-040', currency: 'MYR', rate: 80, unit: 'flat', quantity: 1, amount: 80, active: true }, { id: 'F-003-02', name: '安检费', feeId: 'VF-041', currency: 'MYR', rate: 0.30, unit: 'per-kg', quantity: 1240, amount: 372, minCharge: 100, active: true }, { id: 'F-003-03', name: '货站操作费', feeId: 'VF-042', currency: 'MYR', rate: 0.25, unit: 'per-kg', quantity: 140, amount: 35, minCharge: 80, active: false }], jobBags: 24, jobWeight: 1240 },
    ],
  },
  ...
  // DO-004: Shein Guangzhou → Airport (1 completed with under-invoice, 1 in progress)
  {
    ...
    jobs: [
      { id: 'DO-20260310-004-J01', vendor: { code: 'V-004', name: 'ThaiKee' }, origin: { location: 'Guangzhou Baiyun Airport', date: '2026-03-10 14:00' }, destination: { location: 'Guangzhou Baiyun Airport', date: '2026-03-10 17:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Verified', duration: '03:00', execution: '2026-03-10 14:05', activityLog: [log('l1','2026-03-10 10:00','Job created'), log('l2','2026-03-10 17:00','Status → Completed')], proofDocuments: [doc('d1','gz-trucking-receipt.pdf','application/pdf','2026-03-10 16:50')], rateId: 'RT-016', agreedRate: { currency: 'MYR', amount: 280, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 280 }, invoiceAmount: { currency: 'MYR', amount: 250 }, fees: [{ id: 'F-009-01', name: 'Base rate', feeId: 'RT-016', currency: 'MYR', rate: 280, unit: 'flat', quantity: 1, amount: 280, active: true }], jobBags: 10, jobWeight: 520 },
      { id: 'DO-20260310-004-J02', vendor: { code: 'V-004', name: 'ThaiKee' }, origin: { location: 'Guangzhou Baiyun Airport', date: '2026-03-10 18:00' }, destination: { location: 'Guangzhou Region Airport', date: '2026-03-10 21:00' }, service: { code: 'OH', label: 'Origin Handling' }, status: 'In Progress', duration: null, execution: '2026-03-10 18:10', activityLog: [log('l3','2026-03-10 10:00','Job created'), log('l4','2026-03-10 18:10','Status → In Progress')], proofDocuments: [], rateId: 'RT-017', agreedRate: { currency: 'MYR', amount: 0.65, unit: 'per-kg' }, agreedCost: { currency: 'MYR', amount: 338 }, fees: [{ id: 'F-010-01', name: 'Base rate', feeId: 'RT-017', currency: 'MYR', rate: 0.65, unit: 'per-kg', quantity: 520, amount: 338, active: true }], jobBags: 10, jobWeight: 520 },
    ],
  },
  ...
  // DO-007: Shopee Guangzhou → HK (completed, all match)
  {
    ...
    jobs: [
      { id: 'DO-20260312-007-J01', vendor: { code: 'V-001', name: 'HaleSun' }, origin: { location: 'Guangzhou Warehouse', date: '2026-03-12 09:00' }, destination: { location: 'Huangpu Port', date: '2026-03-12 13:00' }, service: { code: 'FM', label: 'Trucking' }, status: 'Verified', duration: '04:00', execution: '2026-03-12 09:10', activityLog: [log('l1','2026-03-12 07:30','Job created'), log('l2','2026-03-12 13:00','Status → Completed')], proofDocuments: [doc('d1','gz-huangpu-pod.jpg','image/jpeg','2026-03-12 12:55')], rateId: 'RT-003', agreedRate: { currency: 'MYR', amount: 380, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 380 }, invoiceAmount: { currency: 'MYR', amount: 380 }, fees: [{ id: 'F-017-01', name: 'Base rate', feeId: 'RT-003', currency: 'MYR', rate: 380, unit: 'flat', quantity: 1, amount: 380, active: true }], jobBags: 12, jobWeight: 680 },
      { id: 'DO-20260312-007-J02', vendor: { code: 'V-003', name: 'Gonda' }, origin: { location: 'Huangpu Port', date: '2026-03-12 14:00' }, destination: { location: 'Hong Kong Airport', date: '2026-03-12 18:00' }, service: { code: 'EC', label: 'Export Custom Clearance' }, status: 'Verified', duration: '04:00', execution: '2026-03-12 14:05', activityLog: [log('l3','2026-03-12 07:30','Job created'), log('l4','2026-03-12 18:00','Status → Completed')], proofDocuments: [doc('d2','hk-customs-clearance.pdf','application/pdf','2026-03-12 17:50')], rateId: 'RT-008', agreedRate: { currency: 'MYR', amount: 150, unit: 'flat' }, agreedCost: { currency: 'MYR', amount: 150 }, invoiceAmount: { currency: 'MYR', amount: 150 }, fees: [{ id: 'F-018-01', name: 'Base rate', feeId: 'RT-008', currency: 'MYR', rate: 150, unit: 'flat', quantity: 1, amount: 150, active: true }], jobBags: 12, jobWeight: 680 },
    ],
  },
